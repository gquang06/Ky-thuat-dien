...
itn1 = subs(it, [R C Vi], [1e3 1e-6 1]);
fplot(itn1, [0 0.05], 'r--', 'LineWidth', 2);
itn2 = subs(it, [R C Vi], [5e3 1e-6 1]);
fplot(itn2, [0 0.05], 'b-.', 'LineWidth', 2);
itn3 = subs(it, [R C Vi], [10e3 1e-6 1]);
...
vtn1 = subs(vt, [R C Vi], [1e3 1e-6 1]);
fplot(vtn1, [0 0.05], 'r--', 'LineWidth', 2);
vtn2 = subs(vt, [R C Vi], [5e3 1e-6 1]);
fplot(vtn2, [0 0.05], 'b-.', 'LineWidth', 2);
vtn3 = subs(vt, [R C Vi], [10e3 1e-6 1]);
...
vr = Vi - vt;
vrn1 = subs(vr, [R C Vi], [1e3 1e-6 1]);
fplot(vrn1, [0 0.05], 'r--', 'LineWidth', 2);
vrn2 = subs(vr, [R C Vi], [5e3 1e-6 1]);
fplot(vrn2, [0 0.05], 'b-.', 'LineWidth', 2);
vrn3 = subs(vr, [R C Vi], [10e3 1e-6 1]);
